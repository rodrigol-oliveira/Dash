    ...
    (function(f) {
     ...
     t(u.prototype, {
      sanitizeSVG: function(a) {
       ...
       return a = a.replace(/<IMG /g,
        "\x3cimage ").replace(/<(\/?)TITLE>/g, "\x3c$1title\x3e").replace(/height=([^" ]+)/g, 'height\x3d"$1"').replace(/width=([^" ]+)/g, 'width\x3d"$1"').replace(/hc-svg-href="([^"]+)">/g, 'xlink:href\x3d"$1"/\x3e').replace(/ id=([^" >]+)/g, ' id\x3d"$1"').replace(/class=([^" >]+)/g, 'class\x3d"$1"').replace(/ transform /g, " ").replace(/:(path|rect)/g, "$1").replace(/style="([^"]+)"/g, function(a) {
      ...
      getSVG: function(a) {
       var b = this,
        e,
        c, g, x, k, d = q(b.options, a),
        p = d.exporting.allowHTML;
       ...
       e.destroy();
       B(c);
       p && (c = g.match(/<\/svg>(.*?$)/)) && (c = '\x3cforeignObject x\x3d"0" y\x3d"0" width\x3d"200" height\x3d"200"\x3e\x3cbody xmlns\x3d"http://www.w3.org/1999/xhtml"\x3e' + c[1] + "\x3c/body\x3e\x3c/foreignObject\x3e", g = g.replace("\x3c/svg\x3e", c + "\x3c/svg\x3e"));
      ...
      print: function() {
       ...
       if (!a.isPrinting) {
        ...
        E(a, "beforePrint");
        if (p = k && a.chartWidth > k) d = [a.options.chart.width, void 0, !1], a.setSize(k, void 0, !1);
        h(f, function(a, b) {
      ...
      contextMenu: function(a, b, e, c, g, f, k) {
       ...
       l || (d[x] = l = r("div", {
        ...
        "mouseup", u), v(d, "destroy", function() {
        D(n, "mouseup", u)
       }), h(b, function(a) {
        if (a) {
         var b;
     ...
     u.prototype.renderExporting = function() {
      var a, b = this.options.exporting,
       e = b.buttons,
       c = this.isDirtyExporting ||
       !this.exportSVGElements;
      this.buttonOffset = 0;
